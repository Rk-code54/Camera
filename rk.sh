...
echo -e "${yellow}[+] Rk's AI Checking & Installing required packages...${reset}"
...
echo ""
echo -e "${cyan}--------------------------------------------${reset}"
echo -e "${green}  Created by: ROHAN KAVAIYA${reset}"
echo -e "${cyan}--------------------------------------------${reset}"
echo -e "${green}  Subscribe: R-USER YouTube${reset}"
echo -e "${cyan}--------------------------------------------${reset}"
echo ""
